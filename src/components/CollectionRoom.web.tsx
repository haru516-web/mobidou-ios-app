...
export function CollectionRoom({ itemCount, scrollX, zoom, viewportWidth, roomHeight }: CollectionRoomProps) {
  ...
  return <View pointerEvents="none" style={[StyleSheet.absoluteFill, { width: viewportWidth, height: roomHeight }]}>
    <Canvas gl={{ alpha: true }} style={{ position: 'absolute', left: 0, top: 0, right: 0, bottom: 0, backgroundColor: 'transparent' }} orthographic camera={{ left: -WORLD_WIDTH / 2, right: WORLD_WIDTH / 2, top: worldHeight / 2, bottom: -worldHeight / 2, position: [WORLD_WIDTH / 2, 0, 10], rotation: [0, 0, 0], near: 0.1, far: 100 }} dpr={[1, 1.6]}>
