...
import { CollectionGallery } from './src/components/CollectionGallery';
...
function Main({ fontsReady }: { fontsReady: boolean }) {
  ...
  return <View style={S.desktop}><SafeAreaView style={S.app}>
    ...
    <ScrollView ref={scroll} contentContainerStyle={S.content} showsVerticalScrollIndicator={false}>
      ...
      {tab === 'collection' && <CollectionGallery shrines={activeShrines} rewardIds={progress.rewards.map(reward => reward.id)} rewardDates={collectionRewardDates} special={journey.special} onPurchasePass={journey.purchasePass} />}
